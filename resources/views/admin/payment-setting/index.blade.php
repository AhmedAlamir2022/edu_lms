                            ...
                            <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a href="#paypal-setting" class="nav-link active" data-bs-toggle="tab"
                                        aria-selected="false" role="tab" tabindex="-1">Paypal Settings</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="paypal_currency" class="form-control select2">
                                                        @foreach (config('gateway_currencies.paypal_currencies') as $key => $value)
                                                            <option @selected(config('gateway_settings.paypal_currency') == $value['code'])
                                                                value="{{ $value['code'] }}">{{ $value['code'] }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="stripe_currency" class="form-control select2">
                                                        @foreach (config('gateway_currencies.stripe_currencies') as $key => $value)
                                                            <option @selected(config('gateway_settings.stripe_currency') == $value)
