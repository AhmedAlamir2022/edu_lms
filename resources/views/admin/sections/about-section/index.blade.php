                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="lerner_count" placeholder=""
                                        value="{{ $about?->lerner_count }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="lerner_count_text" placeholder=""
                                        value="{{ $about?->lerner_count_text }}">
                                    <x-input-error :messages="$errors->get('lerner_count_text')" class="mt-2" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <x-image-preview src="{{ asset($about?->lerner_image) }}"
                                        style="background-color: rgb(197, 197, 197)" />
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <x-image-preview src="{{ $about?->video_image }}"
                                        style="background-color: rgb(197, 197, 197)" />
