                            ...
                            <form action="{{ route('admin.certificate-builder.update') }}" method="POST"
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" class="form-control" name="title"
                                        value="{{ $certificate?->title }}" placeholder="Enter certificate title">
                                    <x-input-error :messages="$errors->get('title')" class="mt-2" />
                                </div>
                                <div class="form-group mt-3">
                                    <label class="form-label">Certificate Subtitle</label>
                                    <input type="text" class="form-control" name="subtitle"
                                        value="{{ $certificate?->sub_title }}" placeholder="Enter certificate subtitle">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="certificate-body"
                                ...
                                <div id="description" class="descrition draggable-element">{{ $certificate?->description }}
                                </div>
