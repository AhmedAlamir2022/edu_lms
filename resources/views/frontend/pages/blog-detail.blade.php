                    ...
                    <div class="wsus__blog_details_area">
                        ...
                        <div class="wsus__blog_details_header">
                            <ul class="d-flex flex-wrap">
                                <li>
                                    <span class="author">
                                        <img src="{{ $blog->author->image ? asset($blog->author->image) : asset('default-files/avatar.png') }}"
                        ...
                        <div class="wsus__blog_comment_area mt_75">
                            ...
                            @foreach ($blog->comments()->orderBy('id', 'desc')->get() ?? [] as $comment)
                                <div class="wsus__blog_single_comment">
                                    <div class="img">
                                        <img src="{{ $comment->user->image ? asset($comment->user->image) : asset('default-files/avatar.png') }}"
                        ...
                        @else
                            <div class="alert alert-info text-center">You need to <a href="{{ route('login') }}">Login</a> to comment</div>
                        @endauth
                    </div>
                </div>
